  ...
  return (
    ...
    '>
        ...
        <div className='flex items-center justify-evenly'>
            {/* Switch icon */}
            <svg xmlns="http://www.w3.org/2000/svg" className="icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1">
            ...
            {isPlaying ? (
                // pause icon
                <svg onClick={handlePlayPause} xmlns="http://www.w3.org/2000/svg" className="icon fill-gray-900 h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                 strokeWidth="1">
                <path strokeLinecap="round" strokeLinejoin="round" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
            ) : (
                // play icon
                <svg onClick={handlePlayPause} xmlns="http://www.w3.org/2000/svg" className="icon  h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1">
        ...
        <div className="flex justify-end  md:space-x-4 space-x-3 items-center pr-5">
            {/* down */}
            <svg onClick={() => volume > 0 && setVolume(volume - 10)} xmlns="http://www.w3.org/2000/svg" className="icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
            ...
            {/* up */}
            <svg onClick={()=> volume < 100 && setVolume(volume + 10)}  xmlns="http://www.w3.org/2000/svg" className="icon" viewBox="0 0 20 20" fill="currentColor">
