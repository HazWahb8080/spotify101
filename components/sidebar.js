    ...
    overflow-y-scroll h-screen scrollbar-hide text-xs sm:max-w-[12rem]
     lg:max-w-[36rem] lg:w-[15rem] md:w-[12rem] hidden md:inline-block ">
        <div className="space-y-4 w-full items-start justify-start flex flex-col">
            <button onClick={()=>setSearchActive(false)}  className="flex space-x-2 items-center hover:text-white">
            ...
            <button className="flex space-x-2 items-center hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 stroke-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button className="flex space-x-2 items-center hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 stroke-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button className="flex space-x-2 items-center hover:text-white">
               <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 stroke-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
